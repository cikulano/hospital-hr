...
class Person extends \Faker\Provider\Person
{
    ...
    /**
     * @see https://goo.gl/v6bScG document with all pt abreviations *
     */
     ...
     * Generate module
     *
     * @see https://pt.wikipedia.org/wiki/D%C3%ADgito_verificador
     *
    ...
    /**
     * @see https://nomesportugueses.blogspot.pt/2012/01/lista-dos-cem-nomes-mais-usados-em.html
     */
